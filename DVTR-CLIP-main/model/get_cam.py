    ...
    for i in range(0, len(tmp_que_name)):
        ...
        for idx, label in enumerate(label_list):
            ...
            if label_id == que_class[i]:
                ...
                # print(f"attn_weight_last shape: {attn_weight_last.shape}")
                # print(f"grayscale_cam shape before: {grayscale_cam.shape}")
        ...
        attn_weight_list_all.append(attn_weight)
    return refined_cam_all_scales, attn_weight_list_all
