...
class SemData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if 'VOC' in image_path:
            query_name = tmp_sperate[9]
        else:
            query_name = tmp_sperate[7]
            # query_name = tmp_sperate[6]
        ...
        # if len(label_class) == 0:
        #     print(f"Error: label_class is empty for index {index}")
        #     print(f"Image path: {image_path}")
        #     print(f"Label path: {label_path}")
        #     print(f"Label unique values: {np.unique(label).tolist()}")
        #     print(f"Mode: {self.mode}")
        #     print(f"Sub_val_list: {self.sub_val_list}")
        #     print(f"Sub_list: {self.sub_list}")
        #     raise ValueError(f"Empty label_class for index {index}")

        # if len(label_class) == 0:
        #     print(f"Skipping image {image_path} (ID: {index}) due to empty label_class")
